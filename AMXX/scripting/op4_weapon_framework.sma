/*
*	Weapon Factory - Weapons and Items Spawner
*
*						by GordonFreeman
...
public plugin_init() {
	register_plugin("Weapon Factory","0.4","[LF] | Dr.Freeman")
...
public plugin_cfg(){
	...
	formatex(path,255,"%s/weapon_factory/",path)
...
public plugin_end(){	
	...
	fprintf(file,"^n")
	fprintf(file,";^n")
	fprintf(file,"; by [LF] | GordonFreeman")
...
public start_menu(id){
	new menu = menu_create("Weapon Factory","fw_MenuHandler")
	
	menu_additem(menu,"Spawn a Weapon","s1",0)
	menu_additem(menu,"Spawn an Item^n","s2",0)
...
public weapon_menu(id){
	new menu = menu_create("Spawn a Weapon","fw_MenuHandler")
	
	menu_additem(menu,"Pipewrench^n","w1",0)
	menu_additem(menu,"Penguin","w2",0)
	menu_additem(menu," Knife^n","w3",0)
	menu_additem(menu,"Shockrifle","w4",0)
	menu_additem(menu,"Sporelauncher","w5",0)
	menu_additem(menu,"M249^n","w6",0)
	menu_additem(menu,"Grapple","w7",0)
	menu_additem(menu,"Desert Eagle","w8",0)
	menu_additem(menu,"Sniper Rifle","w9",0)
	menu_additem(menu,"Displacer^n","w10",0)
	menu_additem(menu,"Grenade","w11",0)
	menu_additem(menu,"Satchel","w12",0)
	menu_additem(menu,"Tripmine","w13",0)
	menu_additem(menu,"Snark","w14",0)
	menu_additem(menu,"Crowbar","w15",0)
	menu_additem(menu,"357^n","w16",0)
	menu_additem(menu,"9mmAR","w17",0)
	menu_additem(menu,"Crossbow","w18",0)
	menu_additem(menu,"Shotgun","w19",0)
    menu_additem(menu,"RPG","w20",0)
   	menu_additem(menu,"Gauss","w21",0)
	menu_additem(menu,"Egon","w22",0)
	menu_additem(menu,"Hornetgun","w23",0)
...
public ammo_menu(id){
	new menu = menu_create("Spawn an Item","fw_MenuHandler")
	
	menu_additem(menu,"Spore","a1",0)
	menu_additem(menu,"357","a2",0)
	menu_additem(menu,"556","a3",0)
	menu_additem(menu,"762^n","a4",0)
	...
	menu_additem(menu,"9mmbox^n","a10",0)	
	menu_additem(menu,"ARgrenades","a11",0)
	menu_additem(menu,"crossbow","a12",0)		
	m=true
